...
/**
 * Creates a circuit breaker with standard defaults and consistent lifecycle logging.
 * Keep this centralized so all services follow the same resiliency policy.
 */
